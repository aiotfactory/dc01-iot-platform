...
public class ApiKeyModel {
	...
	private Date forwardEmailVerificationTime;
	private Date forwardEmailTime;
	
    public Date getForwardEmailVerificationTime() {
		return forwardEmailVerificationTime;
	}
	public void setForwardEmailVerificationTime(Date forwardEmailVerificationTime) {
	...
	public Date getForwardEmailTime() {
		return forwardEmailTime;
	}
	public void setForwardEmailTime(Date forwardEmailTime) {
