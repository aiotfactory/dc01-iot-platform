...
public class UserModel {
    ...
    private Date buildProjectTime;
    private String  emailActivationToken;
    private Date emailActivationReqTime;
    private Integer emailActivationReqTimes;
    private Date emailActivationRspTime;
    private boolean emailActivationRspResult;
    private String  verificationCode;
    private Date verificationCodeReqTime;
    private Integer verificationCodeReqTimes;
    private Date verificationCodeRspTime;
	...
	public Date getBuildProjectTime() {
		return buildProjectTime;
	}
	public void setBuildProjectTime(Date buildProjectTime) {
	...
	public Date getVerificationCodeReqTime() {
		return verificationCodeReqTime;
	}
	public void setVerificationCodeReqTime(Date verificationCodeReqTime) {
	...
	public Date getVerificationCodeRspTime() {
		return verificationCodeRspTime;
	}
	public void setVerificationCodeRspTime(Date verificationCodeRspTime) {
	...
	public Date getEmailActivationReqTime() {
		return emailActivationReqTime;
	}
	public void setEmailActivationReqTime(Date emailActivationReqTime) {
	...
	public Date getEmailActivationRspTime() {
		return emailActivationRspTime;
	}
	public void setEmailActivationRspTime(Date emailActivationRspTime) {
	...
	public Date getLoginChangeTime() {
		return loginChangeTime;
	}
	public void setLoginChangeTime(Date loginChangeTime) {
