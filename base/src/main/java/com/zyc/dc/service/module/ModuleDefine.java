...
public class ModuleDefine {
	...
	public final static long COMMAND_RSP_SLEEP=100005L;
	...
	public final static long COMMAND_REQ_PIR=14L;
	public final static long COMMAND_REQ_THERMAL=15L;
	public final static long COMMAND_REQ_ULTRASONIC=16L;
	//handler
	...
	private final static ModuleHandler handlerPir=new ModuleHandlerPir();
	private final static ModuleHandler handlerThermal=new ModuleHandlerThermal();
	private final static ModuleHandler handlerUltrasonic=new ModuleHandlerUltrasonic();
	...
	public static ModuleType MODULE_PIR=new ModuleType(20, COMMAND_REQ_PIR,handlerPir,"MODULE_PIR","a PIR module");
	public static ModuleType MODULE_THERMAL=new ModuleType(21, COMMAND_REQ_THERMAL,handlerThermal,"MODULE_THERMAL","a thermal module");
	public static ModuleType MODULE_ULTRASONIC=new ModuleType(22, COMMAND_REQ_ULTRASONIC,handlerUltrasonic,"MODULE_ULTRASONIC","a ultrasonic module");
	public static ModuleType MODULE_MAX=new ModuleType(23, null,null,"MODULE_MAX","dummy max");
	...
	public static void init()
	{
        ...
        new OperateSpec(23, "THERMAL_REQUEST",MODULE_THERMAL,0);
        new OperateSpec(24, "ULTRASONIC_REQUEST",MODULE_ULTRASONIC,0);
	}
	public static class ModuleType{
	    ...
	    private static Map<String,ModuleType> moduleNameMap=new ConcurrentHashMap<>();
		...
		public static ModuleType fromName(String moduleName)
		{
