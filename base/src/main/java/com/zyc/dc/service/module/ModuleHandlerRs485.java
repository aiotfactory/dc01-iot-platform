...
public class ModuleHandlerRs485 extends ModuleHandler {
	//private static final Logger logger = LoggerFactory.getLogger(ModuleHandlerRs485.class);
	public ModuleHandlerRs485()
	{
		super();
    ...
    public byte[] recvUpload(DeviceModel deviceModel,MessageReq msgReq,DataCommModel commModel)
    {
    	...
    	dataUart.setProtocolType(DataUart.ProtocolType.RS485);
    	if(msgReq.getOperate()==null) 
    	{
	    	...
	    	}else if(type==0)//meta
	    	{
				...
				commModel.setInfo("rs485 receive wrong data");
