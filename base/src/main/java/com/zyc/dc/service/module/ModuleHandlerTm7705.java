...
public class ModuleHandlerTm7705 extends ModuleHandler {
    ...
    public Map<String,Object> getChartData(DeviceModel deviceModel,Date startTime,Date endTime,String displayType,Integer page)
    {
    	...
    	String jsonString = "["
    			           + "{ \"operator\": \"max\", \"field\": \"pin1Value\", \"legend\": \"max pin1\", \"color\": \"#80DDFF\" },"
	...
	public Collection<ModuleRuleLogModel> evaluateRule(Object... args)
	{
    	...
    	List<DataCommModel> dataCommList=getMongoDBService().findLatest(query,"uploadTime",30, DataCommModel.class);
